...
<section class="events-section py-5">
    <div class="container">
        ...
        <div class="row" id="eventsContainer">
            <?php
            $sql = "SELECT FestivaliID, Nosaukums, Datums, Laiks, Informacija, Cena, Plakats FROM festivali";
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '    <a href="festival_details.php?id=' . htmlspecialchars($row["FestivaliID"]) . '">';
