...
<head>
    ...
    <title>Biļešu Bāze - Stand-up</title>
...
<section class="events-section py-5">
    <div class="container">
        ...
        <div class="row" id="eventsContainer">
            <?php
            $sql = "SELECT StandupID, Nosaukums, Datums, Laiks, Informacija, Cena, Plakats FROM standup";
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '    <a href="standup_details.php?id=' . htmlspecialchars($row["StandupID"]) . '">';
